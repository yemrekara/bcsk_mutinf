...
#define checkCudaErrors_(val)           check ( (val), #val, __FILE__, __LINE__ )
...
{
    int device_count;
    checkCudaErrors_(cudaGetDeviceCount(&device_count));
    ...
    checkCudaErrors_(cudaGetDeviceProperties(&deviceProp, devID));
    ...
    checkCudaErrors_(cudaSetDevice(devID));
...
inline bool checkCudaCapabilities(int major_version, int minor_version)
{
    ...
    checkCudaErrors_(cudaGetDevice(&dev));
    checkCudaErrors_(cudaGetDeviceProperties(&deviceProp, dev));
